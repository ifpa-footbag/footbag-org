define('./workbox-a1d34bd3.js', ['exports'], function (e) {
  'use strict';
  try {
  ...
  const d = (e, t) => e.filter(e => t in e),
    ...
    m = g,
    q = async ({ request: e, fetchOptions: t, event: s, plugins: r = [] }) => {
      if (
  ...
  class x {
    ...
    async p({
      ...
      let a,
        u = await q({ event: r, plugins: i, request: c });
  ...
  (e.CacheFirst = class {
    ...
    (e.NavigationRoute = class extends r {
      constructor(e, { allowlist: t = [/./], denylist: n = [] } = {}) {
        super(e => this.v(e), e), (this.U = t), (this.L = n);
      }
      v({ url: e, request: t }) {
        if (t && 'navigate' !== t.mode) return !1;
        const n = e.pathname + e.search;
        for (const e of this.L) if (e.test(n)) return !1;
        return !!this.U.some(e => e.test(n));
      }
    }),
    ...
    (e.createHandlerBoundToURL = function (e) {
      return b().createHandlerBoundToURL(e);
    }),
...
//# sourceMappingURL=workbox-a1d34bd3.js.map
